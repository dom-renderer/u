...
class CreateNewWorkflowAssignmentsItemsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('new_workflow_assignments_items', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('new_workflow_assignment_id')->nullable();
    ...
    {
        Schema::dropIfExists('new_workflow_assignments_items');
    }
}
