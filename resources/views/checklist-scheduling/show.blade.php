                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3" id="due_container">
                            <div class="col-6">
                                ...
                                <input type="text" name="start_at" id="start_at" class="form-control" value="{{ date('H:i', strtotime($checklistScheduling->start_at)) }}" disabled>
                            </div>
                            <div class="col-6">
                                <label for="completed_by">Completed By:</label>
                                <input type="text" name="completed_by" id="completed_by" class="form-control" value="{{ date('H:i', strtotime($checklistScheduling->completed_by)) }}" disabled>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-4">
                                ...
                                <input type="text" name="grace_start" id="grace_start" class="form-control" value="{{ date('H:i', strtotime($checklistScheduling->start_grace_time)) }}" disabled>
                            </div>
                            <div class="col-4">
                                <label for="completed_by">Grace End Time</label>
                                <input type="text" name="grace_end" id="grace_end" class="form-control" value="{{ date('H:i', strtotime($checklistScheduling->end_grace_time)) }}" disabled>
                            </div>
                            <div class="col-4">
                                <label for="completed_by">Time Required</label>
                                <input type="text" name="time_required" id="time_required" class="form-control" value="{{ date('H:i', strtotime($checklistScheduling->hours_required)) }}" disabled>
                            </div>
                        </div>
