        ...
        <div class="col-md-12">
            <div class="info-card">
                <div class="d-flex justify-content-between align-items-start mb-3">
                    ...
                    <a href="{{ route('workflow-templates.tree', encrypt($template->id)) }}" class="btn btn-primary btn-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="info-value">{{ $template->children->count() }} steps across {{ count($template->sections ?? []) }} sections</div>
                    </div>
                </div>
