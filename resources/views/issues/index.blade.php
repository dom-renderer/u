...
@section('content')
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            {{ $page_description }}
            @if (auth()->user()->can('issues.create'))
                <a href="{{ route('issues.create') }}" class="btn btn-primary btn-sm float-end">Add Issue</a>
            @endif
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" role="tabpanel" tabindex="0">
                <table class="table table-striped" id="issues-table" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Department</th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        let table = new DataTable('#issues-table', {
            ajax: {
            ...
            columns: [
                 ...
                 { data: 'particular', searchable: false },
                 { data: 'status' },
