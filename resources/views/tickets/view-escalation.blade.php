        ...
        <div class="card-body">
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <select id="particular_id" name="particular_id" disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select id="issue_id" name="issue_id" disabled>
                        @if($escalation->issue)
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" min="1" class="form-control" id="pending_level1_hours" name="pending_level1_hours" value="{{ $escalation->pending_level1_hours }}" disabled />
                ...
                <div class="col-md-5">
                    ...
                    <select id="pending_level1_users" name="pending_level1_users[]" multiple disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select id="pending_level1_notifications" name="pending_level1_notifications[]" multiple disabled>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" min="1" class="form-control" id="pending_level2_hours" name="pending_level2_hours" value="{{ $escalation->pending_level2_hours }}" disabled />
                ...
                <div class="col-md-5">
                    ...
                    <select id="pending_level2_users" name="pending_level2_users[]" multiple disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select id="pending_level2_notifications" name="pending_level2_notifications[]" multiple disabled>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" min="1" class="form-control" id="level1_hours" name="level1_hours" value="{{ $escalation->level1_hours }}" disabled />
                    @error('level1_hours')
                    <span class="text-danger text-left">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-5">
                    ...
                    <select id="level1_users" name="level1_users[]" multiple disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select id="level1_notifications" name="level1_notifications[]" multiple disabled>
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-3">
                    ...
                    <input type="number" min="1" class="form-control" id="level2_hours" name="level2_hours" value="{{ $escalation->level2_hours }}" disabled />
                    @error('level2_hours')
                    <span class="text-danger text-left">{{ $message }}</span>
                    @enderror
                </div>
                <div class="col-md-5">
                    ...
                    <select id="level2_users" name="level2_users[]" multiple disabled>
                ...
                <div class="col-md-4">
                    ...
                    <select id="level2_notifications" name="level2_notifications[]" multiple disabled>
