...
<div class="bg-light p-4 rounded">
    ...
    <form method="POST" action="{{ route('ticket-escalations.store') }}">
        @csrf
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="particular_id" name="particular_id" required></select>
                        @error('particular_id')
                        <span class="text-danger text-left">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="issue_id" name="issue_id" required></select>
                        @error('issue_id')
                        <span class="text-danger text-left">{{ $message }}</span>
                        @enderror
                    </div>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" min="1" class="form-control" id="pending_level1_hours" name="pending_level1_hours" />
                    ...
                    <div class="col-md-5">
                        ...
                        <select id="pending_level1_users" name="pending_level1_users[]" multiple></select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="pending_level1_notifications" name="pending_level1_notifications[]" multiple></select>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" min="1" class="form-control" id="pending_level2_hours" name="pending_level2_hours" />
                    ...
                    <div class="col-md-5">
                        ...
                        <select id="pending_level2_users" name="pending_level2_users[]" multiple></select>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="pending_level2_notifications" name="pending_level2_notifications[]" multiple></select>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" min="1" class="form-control" id="level1_hours" name="level1_hours" required />
                        @error('level1_hours')
                        <span class="text-danger text-left">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-5">
                        ...
                        <select id="level1_users" name="level1_users[]" multiple required></select>
                        @error('level1_users')
                        <span class="text-danger text-left">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="level1_notifications" name="level1_notifications[]" multiple required></select>
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" min="1" class="form-control" id="level2_hours" name="level2_hours" required />
                        @error('level2_hours')
                        <span class="text-danger text-left">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-5">
                        ...
                        <select id="level2_users" name="level2_users[]" multiple required></select>
                        @error('level2_users')
                        <span class="text-danger text-left">{{ $message }}</span>
                        @enderror
                    </div>
                    <div class="col-md-4">
                        ...
                        <select id="level2_notifications" name="level2_notifications[]" multiple required></select>
