...
@section('content')
    ...
    <div class="bg-light p-4 rounded">
        ...
        <div class="lead">
            {{ $page_description }}
            @if (auth()->user()->can('notification-templates.create'))
                <a href="{{ route('notification-templates.create') }}" class="btn btn-primary btn-sm float-end">Add Template</a>
            @endif
        </div>
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="users-tab-pane" role="tabpanel" aria-labelledby="users-tab" tabindex="0">
                <table class="table table-striped" id="template-table" cellspacing="0" width="100%">
                    <thead>
                    <tr>
                        <th>Name</th>
                        <th>Type</th>
...
<script>
    ...
    $(document).ready(function($){
        ...
        let usersTable = new DataTable('#template-table', {
            pageLength: 50,
            ajax: {
